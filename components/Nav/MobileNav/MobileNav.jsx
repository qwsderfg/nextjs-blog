...
const MobileNav = () => {
  ...
  const style = {
    ...
    ul: { // Styling for the unordered list
      display: 'flex', // Setting display property to flex
    ...
    iconContainer: { // Styling for the container of icons
      display: 'flex', // Setting display property to flex
      flexDirection: 'column', // Setting flex direction to column
    ...
    activeIcon: { // Styling for active icons
    ...
    indicatorIcon: { // Styling for the indicator icon
    ...
    indicatorBefore: { // Styling for the indicator before element
        position: 'absolute', // Setting position property to absolute
    ...
    indicatorAfter: { // Styling for the indicator after element
        position: 'absolute', // Setting position property to absolute
        bottom: '31px', // Positioning element
    ...
    homeIndicator: { // Styling for the home indicator
      left: '0', // Positioning indicator
    },
    collectionsIndicator: { // Styling for the collections indicator
      left: '20%', // Positioning indicator
    },
    searchIndicator: { // Styling for the search indicator
      left: '40%', // Positioning indicator
    },
    statsIndicator: { // Styling for the stats indicator
  ...
  return (
    <div style={style.body}> {/* Main container with styles for the navigation */}
      <div style={style.navigation}> {/* Navigation container */}
        <ul style={style.ul}> {/* Unordered list for tabs */}
          {/* Home tab */}
          <li style={style.li} className={activeTab === 'home' ? 'active' : ''}>
            <a href="/" onClick={() => handleTabClick('home')}>
              <span style={style.iconContainer}>
                <BiHomeAlt2 style={activeTab === 'home' ? style.activeIcon : style.icon} />
              </span>
          ...
          <li style={style.li} className={activeTab === 'collections' ? 'active' : ''}>
            <a href="/collections" onClick={() => handleTabClick('collections')}>
              <span style={style.iconContainer}>
                <HiOutlineCollection style={activeTab === 'collections' ? style.activeIcon : style.icon} />
              </span>
          ...
          <li style={style.li} className={activeTab === 'search' ? 'active' : ''}>
            <a href="#" onClick={() => handleTabClick('search')}>
              <span style={style.iconContainer}>
                <FaSearch style={activeTab === 'search' ? style.activeIcon : style.icon} />
              </span>
          ...
          <li style={style.li} className={activeTab === 'stats' ? 'active' : ''}>
            <a href="/stats" onClick={() => handleTabClick('stats')}>
              <span style={style.iconContainer}>
                <BiStats style={activeTab === 'stats' ? style.activeIcon : style.icon} />
              </span>
          ...
          <li style={style.li} className={activeTab === 'connect' ? 'active' : ''}>
            <a onClick={handleConnectClick}>
              <span style={style.iconContainer}>
                <GrConnect style={activeTab === 'connect' ? style.activeIcon : style.icon} />
              </span>
